...
public class Pool {
    ...
    @JsonProperty("running_slots")
    private Integer runningSlots;
    ...
    public Integer getRunningSlots() {
        return runningSlots;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.name, pool.name) &&
                ...
                Objects.equals(this.runningSlots, pool.runningSlots) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, slots, occupiedSlots, runningSlots, queuedSlots, openSlots);
    }
    ...
    public String toString() {
        ...
        sb.append("    runningSlots: ").append(toIndentedString(runningSlots)).append("\n");
